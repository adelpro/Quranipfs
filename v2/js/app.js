$(document).ready(function () {
  ...
  var Nanobar = (function () {
    var c,
      ...
      g,
      h,
      k = { width: "100%", height: "2px", zIndex: 9999, top: "0" },
      l = { width: 0, height: "100%", clear: "both", transition: "height .3s" };
    c = function (a, b) {
    ...
    d.prototype.go = function (a) {
      a
        ? ((this.here = a), this.moving || ((this.moving = !0), f.call(this)))
        : this.moving && f.call(this);
    };
    e = function (a) {
      a = this.opts = a || {};
      var b;
      ...
      a.target
        ? a.target.insertBefore(b, a.target.firstChild)
  ...
  $(".searchit").on("change paste keyup", function () {
    ...
    if (filter == "") {
      ...
      $(".acard .card-content:contains(" + filter + ")")
        .parent(".acard")
        .css("display", "");
    }
  });
  ...
  $("#v").html(
    '<span id="v"><a href="../changelog.html" class="center-align" title="Changelog"> (v3.3 Debug)</a></span>'
  );
});
/*bookmark*/
function loadconfig() {
...
function Loadparam() {
  ...
  if (param > 0) {
    ...
    window.addEventListener("load", (event) => {
      player.seek(getCookie(postseek));
    });
  }
}
function Loadsearchparam() {
  var urlParams = new URLSearchParams(location.search);
  var param = urlParams.get("search");

  $(".searchit").val(param);

  var filter = $(".searchit").val();
  if (filter == "") {
    $(".acard").css("display", "");
  } else {
    $(".acard").css("display", "none");
...
function loadshareit() {
  ...
  <mobileshare3 class='mobileshare3'>
    <a href='https://pinterest.com/pin/create/button/?url=${url}&media=${url}&description=${title}' rel='noreferrer' target='_blank' title='شارك على بانتيراست'>
  ...
  <mobileshare4 class='mobileshare4'>
    <a href='https://t.me/share/url?url=${url}&text=${title}' rel='noreferrer' target='_blank' title='شارك على تيليغرام'>
      <i class='fab fa-telegram-plane'></i>
    </a>
  </mobileshare4>
  <mobileshare class='mobileshare'>
    <a href='https://www.facebook.com/sharer.php?u=${url}&t=${title}' rel='noreferrer' target='_blank' title='شارك على فايسيوك'>
      <i class='fab fab fa-facebook-f'></i>
    </a>
  </mobileshare>
  <mobileshare2 class='mobileshare2'>
    <a class='twitter' href='http://twitter.com/share?url=${encodeURIComponent(
      url
    )}&text=${title}' rel='noreferrer' target='_blank' title='شارك على تويتر'>
      <i class='fab fa-twitter'></i>
    </a>
  </mobileshare2>
  <mobileshare7 class='mobileshare7'>
    <a style='cursor: pointer;' rel='noreferrer' target='_blank' title='إرسال بالبريد الإلكتروني' href='mailto:?subject=QuranIPFS&body=
    ${title}:للاستماع للقرآن الكريم بصوة القارئ 
    %0d
  ...
  <mobileshare6 class='mobileshare6'>
    <a class='clipboard' style='cursor: pointer;' rel='noreferrer' target='_blank' title='نسخ عنوان الصفحة'>
  ...
  $(".clipboard").on("click", function () {
    ...
    $temp.remove();
    M.toast({ html: "تم نسخ العنوان بنجاح" });
  });
}
